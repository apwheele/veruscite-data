...
between 1 to 11 total false positives across the different models in
this corpus (and can shift by a few counts between re-runs of the same
...
typically in the **60–70%** range, but one Perplexity 3.1 flash-lite
...
0.9–1.1% on the 2026-08-13 pair, while OpenAI luna hallucination FP
stayed at 0.1–0.2% and hallucination recall stayed near 72–75%. Cost and
wall time also drift with provider load and search volume (see the cost
table).
